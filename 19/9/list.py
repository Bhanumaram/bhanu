#1write a python program to merge two lists.
...
#2write a python program to find the sum of list elements.
l1=list(eval(input('enter a group of elements separated by comma(,) in a single line: ')))
sum=0
for i in l1:
    sum+=i
...
#4write a python program to delete element of given index in list.
l=list(eval(input('enter a group of elements separated by comma(,) in a single line: ')))
...
#5write a python program to delete given elemet from the list 
l=list(eval(input('enter a group of elements separated by comma(,) in a single line: ')))
...
#6write a python program to insert an elemet  at given index location.
l=list(eval(input('enter a group of elements separated by comma(,) in a single line: ')))
...
#7write a python program to check the sizes of given two lists are same.
l1=list(eval(input('enter a group of elements separated by comma(,) in a single line: ')))
l2=list(eval(input('enter a group of elements separated by comma(,) in a single line: ')))
if (len(l1) == len(l2)):
...
#8Write a Python function that takes two lists and returns True if they have at least one common member.
def list_fun():
    l1=list(eval(input('enter a group of elements separated by comma(,) in a single line: ')))
    l2=list(eval(input('enter a group of elements separated by comma(,) in a single line: ')))
    for ch in l1:
...
#Write a Python program to remove a specified column from a given nested list. Original Nested list: [[1, 2, 3], [2, 4, 5], [1, 1, 1]]')
l=[[1, 2, 3], [2, 4, 5], [1, 1, 1]]
l1=[]
...
#10Write a Python program to remove duplicates from a list.')
